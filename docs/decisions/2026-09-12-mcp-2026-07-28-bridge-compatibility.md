...
tool clients. Existing clients use initialization-based MCP revisions
...
- Add `2026-07-28` to the supported MCP protocol versions.
...
- The implementation does not claim complete MCP 2026-07-28 conformance; MRTR,
  full transport header validation, caching semantics, prompts, resources, and
  extension negotiation remain out of scope.
